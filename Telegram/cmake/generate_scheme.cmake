...
function(generate_scheme target_name script scheme_files)
    ...
    get_filename_component(scheme_codegen_dir ${script} DIRECTORY)
    set(json_script ${scheme_codegen_dir}/generate_dump_to_json.py)
    ...
    set(gen_files
        ...
        ${gen_dst}/scheme-dump_to_json.cpp
        ${gen_dst}/scheme-dump_to_json.h
    )
